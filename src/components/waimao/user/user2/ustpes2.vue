...
import upayee from './upayee'
import utakemoney from './utakemoney'
import ucarriage from '../ucarriage'
import utax2 from './utax2'
import uclosing2 from './uclosing2'
export default{
  components:{
    orders,
    usign,
