  ...
  <div class="d-flex">
    <div class="leftnav">
      ...
      >
        <el-submenu index="1">
          <template slot="title">
            <div v-bind:class="{active:act}">
              <i class="icon">
                <img src="@/assets/waimao/index/home.png" alt />
              </i>
              <span>首页</span>
            </div>
          </template>
        ...
        <el-submenu index="3">
          <template slot="title">
            <div v-bind:class="{active:act3}">
              <i class="icon">
                <img src="@/assets/waimao/index/order.png" alt />
              </i>
              <span>订单列表</span>
            </div>
          </template>
          <el-menu-item-group>
            ...
            <!-- 经理端 -->
            <el-menu-item :index="role_id==3||role_id==4?'/lists':'/lists'">订单列表</el-menu-item>
            <!-- <div class="border"></div>
      ...
      <el-menu-item-group>
        ...
        <!-- <div class="border"></div> -->
        <!-- <el-menu-item index="/emp">业务经理</el-menu-item>
        <div class="border"></div>
        <el-menu-item index="/emp1">销售总监</el-menu-item>
        <div class="border"></div>
        <el-menu-item index="/emp2">总经理</el-menu-item> -->
      </el-menu-item-group>
        </el-submenu>
        <!--  -->
      </el-menu>
...
/* 图标 */
/deep/ .el-submenu__title .icon img {
  margin-top: -5px;
  margin-left: 10px;
  margin-right: 11px;
}
