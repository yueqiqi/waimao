...
12px;color:#999999">(银行费用等)</span></td>
  ...
  <div class="rtitle">费用明细<span style="color:#FF0000;font-size:14px;">如果是代理业务，请补充费用明细</span></div>
  <div class="d-flex">
...
// 小数转为百分数
 ...
 this.all=parseInt(this.fee.consts)+parseInt(this.fee.consts2)+parseInt(this.fee.consts3)+parseInt(this.fee.consts4)+parseInt(this.fee.consts5)
},
//生命周期 - 挂载完成（可以访问DOM元素）
mounted() {
