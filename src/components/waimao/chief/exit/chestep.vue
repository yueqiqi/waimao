...
import orders from './cheorderEntry'
import usign from './checontract'
import upayment from './cheshipment'
import ucarriage from './chepayment'
import urate from './checarriage'
import utake from './chetax'
import uclosing from './checollect'
export default{
  components:{
    orders,
    usign,
