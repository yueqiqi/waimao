...
<div class='add'>
  ...
  <!-- 第一行 -->
    ...
    <!-- 客户类型 -->
      <el-form-item label="客户类型">
        <el-select :disabled="dis" v-model="form.type" placeholder="请选择客户类型">
    ...
    <!-- 联系人 -->
      <el-form-item style="margin-left:101px;" label="联系人">
        <el-input :disabled="dis" placeholder="请填写联系人姓名" v-model="form.username"></el-input>
      </el-form-item>
      <!-- 微信 -->
      <el-form-item style="margin-left:101px;" label="微信">
        <el-input :disabled="dis" type="text" placeholder="请填写客户微信" v-model="form.userwx"></el-input>
      </el-form-item>
    </div>
    ...
    <div class="d-flex">
      ...
      <el-form-item label="单位名称">
        <el-input :disabled="dis" type="text" placeholder="请提供完整正确的单位名称" v-model="form.com"></el-input>
      </el-form-item>
    <!-- 联系电话 -->
      <el-form-item style="margin-left:101px;" label="联系电话">
        <el-input :disabled="dis" type="number" placeholder="请填写联系人电话" v-model="form.userphone"></el-input>
      </el-form-item>
      <!-- whatAPP -->
      <el-form-item style="margin-left:101px;" label="whatAPP">
        <el-input :disabled="dis" type="text" placeholder="请填写客户whatApp" v-model="form.userwhat"></el-input>
      </el-form-item>
    </div>
    <!-- 第三行 -->
    <div class="d-flex">
     <!-- 单位代码 -->
      <el-form-item label="单位代码">
        <el-input :disabled="dis" type="text" placeholder="请提供完整正确的单位代码" v-model="form.code"></el-input>
      </el-form-item>
      <!-- 邮箱 -->
      <el-form-item style="margin-left:101px;;" label="邮箱">
        <el-input :disabled="dis" type="email" placeholder="请填写联系人邮箱" v-model="form.email"></el-input>
      </el-form-item>
    <!-- Facebook -->
      <el-form-item style="margin-left:101px;" label="Facebook">
        <el-input :disabled="dis" type="text" placeholder="请填写客户Facebook" v-model="form.userface"></el-input>
      </el-form-item>
    </div>
    <!-- 第四行 -->
    <div class="d-flex">
      ...
      <el-form-item label="地址">
        ...
        <v-distpicker :disabled="dis" :province="select.province" :city="select.city" @selected="sub" :area="select.area"></v-distpicker>
      </el-form-item>
      <el-form-item>
       <el-input :disabled="dis" style="margin-left:-50px" type="text" placeholder="请填写详细地址" v-model="form.address"></el-input>
      </el-form-item> 
    </div>  
    <!-- 选择客户业务类型 -->
    ...
    <div style="margin-top:26px;">
     <el-form-item label="业务类型">
        <el-select :disabled="dis" v-model="form.type2" placeholder="请选择客户业务类型">
  ...
  <div style="">
    <ul class="el-upload-list el-upload-list--text" v-for="(item,i) in fileList" :key="i">
  ...
  <div style="display: flex;justify-content: center;">
    <button class="mybtn btn" @click="submit">修改资料</button>
  </div>
  </div>
  <!-- 填写客户基本信息 -->
</div>
...
return {
  ...
  formInline: {
        ...
        // 地址选择器
  select: { province: '四川省', city: '资阳市', area: '安岳县' },
  // 
  form:{
    // 客户类型
    type:"中方客户",
...
beforeMount() {
  var userName=this.$route.query
  console.log(userName.userName)
  this.userName=userName.userName
  console.log("传过来的值"+this.userName)
}, //生命周期 - 挂载之前
